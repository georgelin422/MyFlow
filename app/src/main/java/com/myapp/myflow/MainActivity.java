...
public class MainActivity extends Activity implements Flow.Dispatcher {
     ...
     * com.myapp.myflow.pathview.FramePathContainerView}.
     * <p/>
     * The interesting one, loaded by tablets in landscape mode, is {@code res/layout-sw600dp-land}.
     * It loads a {@link com.myapp.myflow.view.TabletMasterDetailRoot}, with a master list on the
     ...
     * the view loaded by {@code root_layout.xml} implements the {@link flow.PathContainerView}
     * interface,
     * to render whatever is appropriate for the screens received from {@link flow.Flow} via
     * {@link #dispatch}.
     */
    @Override
